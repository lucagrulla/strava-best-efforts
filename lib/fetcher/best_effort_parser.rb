    ...
    class BestEffortParser
      ...
      def self.parse(activity_json, maximum_pr_rank)
        ...
        if activity_json['best_efforts'].nil?
          ...
          results = []
          activity_json['best_efforts'].each do |best_effort|
            ...
            if pr_rank.nil?
              ...
              if pr_rank > maximum_pr_rank
                ...
                if activity_json['gear_id'].nil?
                  best_effort_model['gear_name'] = ''
                else
                  best_effort_model['gear_name'] = activity_json['gear']['name']
                end
