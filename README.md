...
This small app is designed to fetch and visualize Strava running best efforts,
...
4. A background process runs on the server and gets the data using Strava API.
5. Once it's all done, users can see a detailed user interface for analyzing their best efforts data.
